 ...
 */
export const APP_NAME: string = 'dobi-game';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'dodge obstacles in a digital world as DOBI, the onchain AI agent';
 ...
 */
export const APP_TAGS: string[] = ['DOBI', 'OnchainAI', 'CryptoGaming', 'AIgaming', 'GameFi', 'OnchainGames', 'Virtuals', 'DePIN', 'RWA', 'Arcade'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Play';
